...
class Movie(models.Model):
    ...
    budget = models.PositiveIntegerField('Бюджей', default=0, help_text="указывать сумму в долларах")
...
class MovieShots(models.Model):
    ...
    title = models.CharField('Название', max_length=100)
    description = models.TextField('Описание')
    image = models.ImageField('Изображегие', upload_to='movie_shots/')
    film = models.ForeignKey(Movie, verbose_name='Фильм', on_delete=models.CASCADE)
